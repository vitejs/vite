...
If you use a metaframework that has Vite as a peer dependency, in order to use Vite 8 beta, you have to override the `vite` dependency in your `package.json`, which works slightly different depending on your package manager:
