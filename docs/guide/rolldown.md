...
This is because [Rolldown supports non-JavaScript modules](https://rolldown.rs/options/module-types) and infers the module type from extensions unless specified.
