...
Currently, Vite is working on an improved SSR API with the [Environment API](https://github.com/vitejs/vite/pull/16089). Check out ithe link for more details.
:::
