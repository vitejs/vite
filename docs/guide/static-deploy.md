...
Follow the steps in [the vite deployment guide](https://docs.zephyr-cloud.io/recipes/react-vite) to get started, or, if you use [Rolldown](https://rolldown.rs/) use [the rolldown one](https://docs.zephyr-cloud.io/recipes/rolldown-react).
