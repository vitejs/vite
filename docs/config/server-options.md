...
Extends [`http-proxy`](https://github.com/http-party/node-http-proxy) (full options [here](https://github.com/http-party/node-http-proxy#options)). Additional options are [here](https://github.com/vitejs/vite/blob/main/packages/vite/src/node/server/middlewares/proxy.ts#L13).
