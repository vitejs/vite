...
- A dev server that provides [rich feature enhancements](<[./features](https://vite.dev/guide/features)>) over [native ES modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules), for example extremely fast [Hot Module Replacement (HMR)](<[./features](https://vite.dev/guide/features)#hot-module-replacement>).
