 ...
 */
function validateRuntimeChunk(chunk) {
 ...
 */
function validateChunkImports(chunk) {
 ...
 */
function replaceConfusingTypeNames(code, chunk) {
 ...
 * pass here.
 */
function stripInternalTypes(code, chunk) {
 ...
 */
function removeInternal(s, node) {
  if (
...
function cleanUnnecessaryComments(code) {
  return code
