...
test('export function declaration', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "foo", { enumerable: true, configurable: true, get(){ try { return foo } catch {} }});
    function foo() {}"
  `,
  )
})
...
test('export var declaration', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "a", { enumerable: true, configurable: true, get(){ try { return a } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "b", { enumerable: true, configurable: true, get(){ try { return b } catch {} }});
    const a = 1, b = 2"
  `,
  )
})
...
test('export named', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "a", { enumerable: true, configurable: true, get(){ try { return a } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "c", { enumerable: true, configurable: true, get(){ try { return b } catch {} }});
    const a = 1, b = 2; "
  `,
  )
})
...
test('export named from', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "ref", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__.ref } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "c", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__.computed } catch {} }});
...
test('named exports of imported binding', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "createApp", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__.createApp } catch {} }});
...
test('export * as from', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "foo", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__ } catch {} }});
...
`),
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "foo", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_1__ } catch {} }});
...
`),
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "foo", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_1__.foo } catch {} }});
...
test('export * as from arbitrary module namespace identifier', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "arbitrary string", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__ } catch {} }});
    const __vite_ssr_import_0__ = await __vite_ssr_import__("vue");"
  `,
  )
})
...
test('export as arbitrary module namespace identifier', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "arbitrary string", { enumerable: true, configurable: true, get(){ try { return something } catch {} }});
...
test('export as from arbitrary module namespace identifier', async () => {
  expect(
    ...
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "arbitrary string", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_0__["arbitrary string2"] } catch {} }});
...
test('export default', async () => {
  expect(await ssrTransformSimpleCode(`export default {}`))
    .toMatchInlineSnapshot(`
      "globalThis.Object.defineProperty(__vite_ssr_exports__, "default", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_export_default__ } catch {} }});
...
test('dynamic import', async () => {
  ...
  expect(result?.code).toMatchInlineSnapshot(
    `
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "i", { enumerable: true, configurable: true, get(){ try { return i } catch {} }});
...
test('should declare variable for imported super class', async () => {
  ...
  expect(
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "default", { enumerable: true, configurable: true, get(){ try { return A } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "B", { enumerable: true, configurable: true, get(){ try { return B } catch {} }});
    const __vite_ssr_import_0__ = await __vite_ssr_import__("./dependency", {"importedNames":["Foo"]});const Foo = __vite_ssr_import_0__.Foo;
    class A extends Foo {};
    class B extends Foo {}"
...
test('should handle default export variants', async () => {
  ...
  expect(
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "default", { enumerable: true, configurable: true, get(){ try { return foo } catch {} }});
    function foo() {};
    foo.prototype = Object.prototype;"
  `)
...
export function fn1() {
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "fn1", { enumerable: true, configurable: true, get(){ try { return fn1 } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "fn2", { enumerable: true, configurable: true, get(){ try { return fn2 } catch {} }});
...
export class Test {
  ...
  expect(await ssrTransformSimpleCode(code)).toMatchInlineSnapshot(`
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "Test", { enumerable: true, configurable: true, get(){ try { return Test } catch {} }});
...
console.log(bar)
  `),
    ...
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "default", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_export_default__ } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "bar", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_1__ } catch {} }});
...
`)
  expect(result?.code).toMatchInlineSnapshot(`
    "globalThis.Object.defineProperty(__vite_ssr_exports__, "b", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_1__.b } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "d", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_3__ } catch {} }});
    globalThis.Object.defineProperty(__vite_ssr_exports__, "A", { enumerable: true, configurable: true, get(){ try { return __vite_ssr_import_4__ } catch {} }});
    const __vite_ssr_import_0__ = await __vite_ssr_import__("a", {"importedNames":["default"]});
