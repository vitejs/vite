  ...
  return {
    ...
    transform(code, id, options) {
      if (id === normalizedClientEntry || id === normalizedEnvEntry) {
        ...
        const clientPort = options.clientPort
          ? String(options.clientPort)
          : null

        let port: number | string | undefined = options.port
        ...
        return code
          ...
          .replace(`__HMR_CLIENT_PORT__`, JSON.stringify(clientPort))
