  ...
  return {
    ...
    resolveId(id) {
      ...
      if (mime !== 'text/javascript') {
        throw new Error(
          `data URI with non-JavaScript mime type is not supported. If you're using legacy JavaScript MIME types (such as 'text/javascript'), please use 'text/javascript' instead.`,
        )
      }
