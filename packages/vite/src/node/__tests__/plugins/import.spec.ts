...
describe('transformCjsImport', () => {
  ...
  test('import all specifier', () => {
    expect(
      ...
      'import __vite__cjsImport0_react from "./node_modules/.vite/deps/react.js"; ' +
        `const react = ((m) => m?.__esModule ? m : Object.assign(m && typeof m === "object" && !Array.isArray(m) ? Object.create(Object.getPrototypeOf(m), Object.getOwnPropertyDescriptors(m)) : {}, { default: m }))(__vite__cjsImport0_react)`,
    )
  })
