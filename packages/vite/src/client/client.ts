...
declare const __HMR_DEFAULT_PORT__: string
...
const socketPort =
  __HMR_DEFAULT_PORT__ === 'undefined' ? location.port : __HMR_PORT__
const socketHost = `${__HMR_HOSTNAME__ || location.hostname}:${socketPort}`
