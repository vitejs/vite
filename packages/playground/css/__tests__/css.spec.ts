...
describe('css.spec.ts', () => {
  ...
  it('css modules composes/from path resolving', async () => {
  ...
  it('sass modules composes/from path resolving', async () => {
  ...
  it('less modules composes/from path resolving', async () => {
  ...
  it('@import dependency w/ style entry', async () => {
    expect(await getColor('.css-dep')).toBe('purple')
  })

  it('@import dependency w/ sass entry', async () => {
    expect(await getColor('.css-dep-sass')).toBe('orange')
  })

  it('@import dependency w/ stylus entry', async () => {
    expect(await getColor('.css-dep-stylus')).toBe('red')
  })

  it('@import dependency w/out package scss', async () => {
  ...
  it('treeshaken async chunk', async () => {
    if (isBuild) {
  ...
  it('PostCSS dir-dependency', async () => {
