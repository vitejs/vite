import { editFile, untilUpdated, mochaReset, mochaSetup } from '../../testUtils'
import { port } from './serve'
import fetch from 'node-fetch'

const url = `http://localhost:${port}`

describe('ssr-react.spec.ts', () => {
  before(mochaSetup)
  after(mochaReset)
  ...
  it(`circular dependecies modules doesn't throw`, async () => {
    await page.goto(url)
