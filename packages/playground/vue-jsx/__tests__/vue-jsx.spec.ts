...
describe('vue-jsx.spec.ts', () => {
  ...
  if (!isBuild) {
    ...
    it('hmr: named export via specifier', async () => {
      editFile('Comps.jsx', (code) =>
    ...
    it('hmr: src import in .vue', async () => {
      await page.click('.script')
