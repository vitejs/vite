...
test.runIf(!isBuild && !isBundledDev)(
...
test.skipIf(isBundledDev)('import.meta.glob eager in worker', async () => {
  await expect
...
test.skipIf(isBundledDev)(
  'self reference url worker in dependency',
  async () => {
    await expect
...
test.runIf(isServe && !isBundledDev)(
  'sourcemap is correct after env is injected',
  async () => {
