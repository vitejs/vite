// Standalone HMR workflow for the create-vite `preact` template under Vite full-bundle mode.
...
async function run() {
  ...
  console.log(
    `PASS ${TAG}: preact hot-swapped src/app.jsx with counter state preserved.`,
  )
  await cleanup(0)
}
