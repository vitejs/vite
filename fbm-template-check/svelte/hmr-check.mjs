// Standalone HMR workflow for the create-vite `svelte` template under Vite full-bundle mode (FBM).
...
// (`let count = $state(0)`) reset to their initial value. This is the BASELINE behavior in
// plain non-FBM dev too — Svelte 5 dropped svelte-hmr's `preserveLocalState`. Hence the
